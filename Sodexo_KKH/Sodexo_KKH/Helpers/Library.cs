...
namespace Sodexo_KKH.Helpers
{
    public class Library
    {
      ...
      // public static string URL = "https://kkhemosvpapp11.kkh.shs.com.sg/Sodexo_services/Sodexo.svc/";  // for KKH production
       ...
       // public static string VersionNumber = "K-5.1.3 U"; //for UAT or DC
        public static string VersionNumber = "K-5.1.3 Q"; //for QA
       //  public static string VersionNumber = "K-5.1.3 P"; //for Production
